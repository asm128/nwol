...
#pragma pack(push, 1)
		struct SAttributeId {
						...
						uint32_t							pos:31;
															...
															SAttributeId				(const ::nwol::id_t nodeId)																		: dir((nodeId & 0x80000000L)>>31),	pos(nodeId &  0x7FFFFFFFL)	{}
															SAttributeId				(const char key, const uint32_t index)															: dir(key),							pos(index)					{}
...
#pragma pack(pop)
		...
		inline		::nwol::error_t						validateNodeIndex			(::nwol::id_t nodeIndex)																			{ return (0 > nodeIndex || ((::nwol::id_t)NodeInstances.size()) <= nodeIndex) ? -1 : 0; }
