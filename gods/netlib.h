...
namespace nwol
{
	...
	template<typename _tPOD>	inline	int32_t		sendUserCommand				(SConnectionEndpoint* pOrigin, SConnectionEndpoint* pTarget, USER_COMMAND	requestOrResponse, const _tPOD		& podSourceInstance) { return sendUserCommand		(pOrigin, pTarget, requestOrResponse, &podSourceInstance, sizeof(_tPOD)); };
