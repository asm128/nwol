...
namespace nwol 
{
		...
		*nwol_reference										= 0;
		if(oldRef)
			...
			case 0:
				...
				break;
			case -1:
				error_printf("Reference count error!");
				return -1;
			}
		return 0;
	};
	...
	public:
		...
		inline				_tNCO*							as									(_tNCOOther** other)								noexcept	{ retirm *other = (Instance ? (_tNCOOther*)Instance->Instance : 0);	}
	...
	public:
		...
		inline				const _tPOD*					operator->							()											const	noexcept	{ return Instance;														}
		inline				_tPOD*							operator->							()													noexcept	{ return (0 == Instance) ? ::nwol::ref_allocate(&Instance) : Instance;	}
