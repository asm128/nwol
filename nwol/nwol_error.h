...
namespace nwol
{
	...
	static inline constexpr		bool										failed						(error_t errorCode)		noexcept	{ return 0 >  errorCode; }
	static inline constexpr		bool										succeeded					(error_t errorCode)		noexcept	{ return 0 <= errorCode; }
#if defined (__WINDOWS__)
